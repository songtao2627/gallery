...
const Footer: React.FC = () => {
  return (
    <footer className="relative z-10 w-full pt-10 pb-6 px-4">
      <div className="mx-auto max-w-7xl rounded-[3rem] bg-white/[0.15] backdrop-blur-xl border border-white/[0.18] px-8 py-12 md:px-12 shadow-[0_8px_32px_0_rgba(31,38,135,0.37)]">
